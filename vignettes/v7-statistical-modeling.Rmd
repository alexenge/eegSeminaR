...
[^1]: **Souce:** [Imgur](https://imgur.com/KWXSw), [YouTube](https://www.youtube.com/watch?v=LEKwQxO4EZU)
...
-   This effect explains 8.7% of the variance in the N170 (see $R^2$)
...
-   Define model formula:
    ...
    -   **Fixed effects** :
        ...
        -   Everything after `~` but not in paranthesis
...
-   Note that rmANOVA has a number of drawbacks compared to a mixed model:
    ...
    -   Independence assumption violated because participant effects and item effects cannot be accounted for simultanously[^5]
